...
<html>
	        	...
	        	<div id="myCarousel" class="carousel slide">
	                ...
	                <div class="carousel-inner">
	                    <div class="item active">
	                        <img src="img/hd1.jpg" alt="first slide" />
	                    </div>
	                    <div class="item">
	                        <img src="img/hd2.jpg" alt="second slide" />
	                    </div>
	                </div>
						<!-- 轮播（Carousel）导航 -->
        ...
        <div class="slist">
        	<ul class="clearfix">
        		<!--<li>
        			...
        			<div><button class='btn btn-primary sc-btn'>收藏</button>  下载量</div>
        		</li>-->
        	</ul>
        </div>
		...
		<script type="text/javascript">
			...
			function build_emps_table(result) {
				...
				$.each(Astu, function(index, item) {
					...
					var div = $("<div></div>").append(a1)
							.append("&nbsp;&nbsp;下载量 ("+item.downloadvolume+")&nbsp;&nbsp;点击量  ("+item.clickvolume+")");
			...
			function getID(id){
				...
				$.ajax({
					...
					success:function(result){
						...
						if(result.code == 100){
							$("#scModal .tan-img img").attr("src","/image/"+pr.pictureurl).attr("title",pr.picturetitle);
							url=pr.pictureurl;
  ...
  <script src="${path }bootstrap-3.3.7/js/bootstrap.min.js"></script>
</html>
